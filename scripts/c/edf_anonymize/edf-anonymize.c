...
Updated by Joshua Asuncion: 08 March 2022
...
main(int argc, char **argv)
{
  ...
  " SDATE is optional, and is '01.01' (1 January) by default.\n",
    ...
    if (argc <= 5)
	strncpy(buf+168, "01.01.00", 8);  /* 01.01.00 is 1 January 2000 */
    else if (argv[5][0] == '+') {
	static char date[9];
	long delta, jdate;
    ...
    else if (strlen(argv[5]) == 8 && argv[5][2] == '.' && argv[5][5] == '.')
	strncpy(buf+168, argv[5], 8);
